...
// -----------------------------------------------------------------------------
	...
	<tbody>
		<tr>
			...
			<td style="width: 270.6px; text-align: center;"><strong>Perincian Biaya</strong></td>
			<td style="width: 151px; text-align: center;"><strong>Jumlah</strong></td>
			<td style="width: 151px; text-align: center;"><strong>Keterangan</strong></td>
		</tr>
		<tr>
			<td style="width: 30.4px;">1.</td>
			<td style="width: 270.6px;">Nama yang berangkat : '. $row['name'].'</td>
			<td style="width: 151px;">&nbsp;</td>
			<td style="width: 151px;">&nbsp;</td>
		</tr>
		<tr>
			<td style="width: 30.4px;">2.</td>
			<td style="width: 270.6px;">NIP. '. $row['officer_id'].'</td>
			<td style="width: 151px;">&nbsp;</td>
			<td style="width: 151px;">&nbsp;</td>
		</tr>
		<tr>
			<td style="width: 30.4px;">3.</td>
			<td style="width: 270.6px;">Golongan : '. $row['office_class_name'].'</td>
			<td style="width: 151px;">&nbsp;</td>
			<td style="width: 151px;">&nbsp;</td>
		</tr>
		<tr>
			<td style="width: 30.4px;">4.</td>
			<td style="width: 270.6px;">Uang Harian : 1 x '. $row1['total_day'].' x Rp. '.number_format($row['daily_cost'], 2, ',', '.').'</td>
			<td style="width: 151px;"> Rp. '.number_format($row['total_daily_cost'], 2, ',', '.').'</td>
			<td style="width: 151px;">&nbsp;</td>
		</tr>
		<tr>
			<td style="width: 30.4px;">5.</td>
			<td style="width: 270.6px;">Biaya Penginapan : 1 x '. ($row1['total_day'] -1 ).' x Rp. '.number_format($row['lodging_cost'], 2, ',', '.').'</td>
			<td style="width: 151px;"> Rp. '.number_format($row['total_lodging_cost'], 2, ',', '.').'</td>
			<td style="width: 151px;">&nbsp;</td>
		</tr>
		<tr>
			<td style="width: 30.4px;">6.</td>
			<td style="width: 270.6px;">Transport Tangerang - '.$row1['objective'].' : Rp. '.number_format($row['transportation_cost'], 2, ',', '.').'</td>
			<td style="width: 151px;"> Rp. '.number_format($row['transportation_cost'], 2, ',', '.').'</td>
			<td style="width: 151px;">&nbsp;</td>
		</tr>
		<tr>
			<td style="width: 301px;" colspan="2">JUMLAH</td>
			<td style="width: 151px;"> Rp. '.number_format($row['total_cost'], 2, ',', '.').'</td>
			<td style="width: 151px;">&nbsp;</td>
		</tr>
		<tr>
		<td style="width: 603px;" colspan="4">Terbilang : '. $row['total_cost_rp'].'</td>
		</tr>
</tbody>

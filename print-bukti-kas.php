...
// -----------------------------------------------------------------------------
	...
	$html2 = "";
	$html2.='<table style="height: 59px; width: 645px;">
		<tbody>
		<tr>
			<td style="width: 445px; text-align: right;">No. BKU</td>
			<td style="width: 200px;">: '. $row['kas_reference_number'].'</td>
		</tr>
		<tr>
			<td style="width: 445px; text-align: right;">Tahun</td>
			<td style="width: 200px; text-align: left;">: '.$tahun['year'].'</td>
		</tr>
		</tbody>
		</table>';
	...
	$html.='<table>
		...
		<tr style="height: 18px;">
			...
			<td style="width: 400px; height: 18px;">: '. $row['name'].'&nbsp;</td>

...
$admin = '<u>LAPORAN HASIL DINAS PEGAWAI</u>';
	   ...
	   $data = $_SESSION["data"];
		...
		<thead>
		  <tr style="background-color: #9400D3; text-align: center; height: 27.2px;">
			...
			<th><strong><span style="color: #ffffff;">NIP / Nama Pegawai</span></strong></th>
			<th><strong><span style="color: #ffffff;">Tugas</span></strong></th>
			<th><strong><span style="color: #ffffff;">Kota</span></strong></th>
			<th><strong><span style="color: #ffffff;">Isi Laporan</span></strong></th>
		  </tr>
		</thead>';

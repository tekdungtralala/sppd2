...
$admin = '<u>LAPORAN SURAT PERJALANAN DINAS (SPD)</u>';
...
// -----------------------------------------------------------------------------
	   ...
	   $data = $_SESSION["data"];
		...
		$tbl .= '
		<table style="height: 39px; width: 658.6px;" border="1">
		<thead>
		  <tr style="background-color: #9400D3; text-align: center; height: 27.2px;">
			...
			<th><strong><span style="color: #ffffff;">Kota</span></strong></th>
			<th><strong><span style="color: #ffffff;">Angkutan</span></strong></th>
			<th><strong><span style="color: #ffffff;">Lama Jalan</span></strong></th>
			<!-- <th><strong><span style="color: #ffffff;">Status</span></strong></th> -->
		  </tr>
		</thead>';
	...
	foreach ($data as $d) {
		...
		foreach ($d->officers as $o) {
			...
			$tbl .= "<td>".$d->transportation_type."</td>";
			$tbl .= "<td>".$d->total_day. " hari </td>";

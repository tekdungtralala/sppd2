...
$admin = '<u>LAPORAN BIAYA DINAS PEGAWAI</u>';
...
// -----------------------------------------------------------------------------
	   ...
	   $data = $_SESSION["data"];
		...
		<thead>
		  <tr style="background-color: #9400D3; text-align: center; height: 27.2px;">
			...
			<th><strong><span style="color: #ffffff;">No. ST</span></strong></th>
			<th><strong><span style="color: #ffffff;">No. SPD / Nama</span></strong></th>
			<th><strong><span style="color: #ffffff;">Kota / Angkutan</span></strong></th>
			<th><strong><span style="color: #ffffff;">Jumlah</span></strong></th>
			<th><strong><span style="color: #ffffff;">Jumlah Total</span></strong></th>
	...
	foreach ($data as $d) {
		...
		foreach ($d->officers as $o) {
			...
			$tbl .= $o->reference_number." - ".$o->name."<br/>";
			
			
		}
			$tbl .= "</td>";
			$tbl .= "<td>".$d->objective." / ".$d->transportation_type."</td>";
		...
		$tbl .= "<td> Rp " .number_format($t, 2, ',', '.')."</td>";

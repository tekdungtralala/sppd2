...
$image_file = K_PATH_IMAGES.'logobppt.jpg';
$pdf->Image($image_file, 20, 26, 25, '', 'JPG', '', 'T', false, 30, '', false, false, 0, false, false, false);
...
$pdf->Write(0, $txt2, '', 0, 'C', true, 0, false, true, 0);
...
// -----------------------------------------------------------------------------
	...
	$html.='<table style="width: 100px;">
				<tbody>
					<tr style="height: 5px;">
						...
						<td style="width: 250px; height: 10px;"><strong>Nomor : '.$row['reference_number'] .'</strong></td>
					</tr>
				</tbody>
			</table>';
	...
	<tbody>
		...
		<tr style="height: 60px;">
			...
			<td style="width: 430px; height: 70px;">';
				while($row1 = $result1->fetch_assoc()) {
					$html2.=  $row1['name'] . " / NIP. " . $row1['officer_id'] . '<br/>';
				}
			$html2.='</td>
		...
		<tr style="height: 60px;">
			...
			<td style="height: 36px;">:</td>
			<td style="width: 430px; height: 20px;">'.date('d F Y', strtotime($row['start_date'])).' - '.date('d F Y', strtotime($row['end_date'])).' ('.$row['total_day'] .') hari</td>
		</tr>
		<tr style="height: 60px;">
			<td style="width: 200px; height: 36px;">Tujuan</td>
			<td style="height: 36px;">:</td>
			<td style="width: 430px; height: 20px;">'.$row['objective'] .'</td>
		</tr>
		<tr style="height: 60px;">
			<td style="width: 200px; height: 36px;">Tugas</td>
			<td style="height: 36px;">:</td>
			<td style="width: 430px; height: 20px;">'.$row['task'] .'</td>
		</tr>
	...
	$html3 = "";
	$html3.='<table style="width: 100px;">
				<tbody>
					<tr style="height: 5px;">
						<td style="width: 160px; height: 41px;"></td>
						<td style="width: 360px; height: 41px;"></td>
						<td style="width: 200px; height: 100px;">'.$row['chief_name'] .'</td>
					</tr>
				</tbody>
			</table>';

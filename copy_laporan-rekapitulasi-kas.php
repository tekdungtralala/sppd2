...
session_start();
	...
	<tr>
		...
		<thead>
		  <tr style="background-color: #9400D3; text-align: center; height: 27.2px;">
		  	...
		  	<th><strong><span style="color: #ffffff;">Tahun Anggaran</span></strong></th>
		  	<th><strong><span style="color: #ffffff;">Nomor Kode DIPA</span></strong></th>
		  	<th><strong><span style="color: #ffffff;">Tanggal Kode DIPA</span></strong></th>
			...
			<th><strong><span style="color: #ffffff;">Nama / NIP</span></strong></th>
			<th><strong><span style="color: #ffffff;">No. BKU</span></strong></th>
			<th><strong><span style="color: #ffffff;">Kegiatan Output - Mata Anggaran</span></strong></th>
			<th><strong><span style="color: #ffffff;">Kode Pusat</span></strong></th>
			<th><strong><span style="color: #ffffff;">Uraian</span></strong></th>
			<!-- <th><strong><span style="color: #ffffff;">Jumlah</span></strong></th> -->
			<th><strong><span style="color: #ffffff;">Total</span></strong></th>
		</tr>
		</thead>';
	...
	foreach ($data as $d) {
		...
		$tbl .= "</tr>";
			...
			$tbl .= "<tr><td></td><td></td><td></td><td></td><td></td>";
				$tbl .= "<td colspan='7'>Total Keuangan per Bulan</td>";
